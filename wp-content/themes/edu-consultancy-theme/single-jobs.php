			...
			<article id="job-<?php echo esc_attr( $job_id ); ?>" <?php post_class( 'edu-single-job' ); ?>>
				<header class="edu-single-job__header">
					...
					<div class="edu-single-job__meta">
						<?php if ( $company_name ) : ?>
							<span class="edu-single-job__company"><?php echo esc_html( $company_name ); ?></span>
						<?php endif; ?>
						<?php if ( $location ) : ?>
							<span class="edu-single-job__location"><?php echo esc_html( $location ); ?></span>
						<?php endif; ?>
						<?php if ( $salary_range ) : ?>
							<span class="edu-single-job__salary"><?php echo esc_html( $salary_range ); ?></span>
						<?php endif; ?>
						<?php if ( ! empty( $job_type_labels ) ) : ?>
							<span class="edu-single-job__type"><?php echo esc_html( implode( ', ', $job_type_labels ) ); ?></span>
						<?php endif; ?>
					</div>
					...
					<?php if ( has_post_thumbnail( $job_id ) || $company_logo ) : ?>
						<div class="edu-single-job__media">
							...
							if ( has_post_thumbnail( $job_id ) ) {
								the_post_thumbnail( 'medium_large', array( 'class' => 'edu-single-job__image' ) );
							} elseif ( $company_logo ) {
								echo '<img class="edu-single-job__image" src="' . esc_url( $company_logo ) . '" alt="' . esc_attr( $company_name ? $company_name : get_the_title() ) . '" />';
							}
							?>
						</div>
					<?php endif; ?>
				...
				<aside class="edu-single-job__details">
